...
namespace Infrastructure.Services.BattleServiceFolder
{
    public class BattleService : IBattle
    {
        ...
        /*
            ...
            5. Ako izabere da udari heroja, bira se random protivnicki igrac i koristi AttackHero() da izvrsi napad.
            ovo ide u Attack logiku -> 6. Proverava se da li igrac koji udara ima manje health od pola i u tom slucaju ako ima health potion, popice ga.
            7. Na kraju svakog kruga, proverava se da li je neki tim izgubio sve igrace
         */



        // PROVERITI UVEK DA LI JE MRTAV NEKO
